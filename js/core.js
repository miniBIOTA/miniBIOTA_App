...
const CHECKLIST_ITEMS = {
  ...
  short: [
    ...
    { id: "pipe",       label: "Pipeline record created",             sub: "content_pipeline — title, format=short, published URL, published date, biome ID, primary species ID, story angle in notes. No markdown doc." },
    { id: "calupdate",  label: "Content calendar updated",            sub: "Status → published, attach pipeline record ID" },
    { id: "openloops",  label: "Open loops seeded",                   sub: "New open_loops records for any audience questions the video poses. Shorts loops can retire if they become irrelevant." },
    { id: "threads",    label: "Story threads — no action needed",    sub: "Linked threads stay open and keep accumulating. A short does not close a thread." },
    { id: "biomenotes", label: "Biome / species / system notes updated", sub: "Update any records where something changed — new behavior confirmed, new species established, biome state shifted." },
    { id: "chronicles", label: "Chronicles — promote if warranted",   sub: "Create a chronicle entry if observations capture something ecologically significant." },
    { id: "confirm",    label: "Confirm",                             sub: "Read back all changes and get explicit confirmation before closing the session." },
  ],
  mf: [
